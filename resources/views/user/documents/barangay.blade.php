...
<body class="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
    ...
    <!-- Header -->
    <header class="print-hide bg-white/80 backdrop-blur-sm border-b border-white/20 shadow-sm p-4 sm:p-6 mb-4 sm:mb-8">
    ...
    <div class="flex flex-col lg:flex-row gap-4 sm:gap-6 p-4 sm:p-6">
        <!-- LEFT PANEL - FORM -->
        <div class="print-hide w-full lg:w-1/3 bg-white rounded-2xl shadow-lg p-4 sm:p-6">
            ...
            <form action="{{ route('user.request.document') }}" method="POST" class="space-y-3 sm:space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="text" id="firstName" name="first_name" value="{{ $reqFirstName }}" class="w-full bg-slate-50 border-0 rounded-xl px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20" placeholder="First name" required>
                    </div>
                    <div>
                        <label class="block text-xs sm:text-sm font-medium text-slate-700 mb-2">Middle Name</label>
                        <input type="text" id="middleName" name="middle_name" value="{{ $reqMiddleName }}" class="w-full bg-slate-50 border-0 rounded-xl px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20" placeholder="Middle name">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="text" id="lastName" name="last_name" value="{{ $reqLastName }}" class="w-full bg-slate-50 border-0 rounded-xl px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20" placeholder="Last name" required>
                    </div>
                    <div>
                        <label class="block text-xs sm:text-sm font-medium text-slate-700 mb-2">Suffix</label>
                        <input type="text" id="suffix" name="suffix" value="{{ $reqSuffix }}" class="w-full bg-slate-50 border-0 rounded-xl px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20" placeholder="Jr., Sr., III">
                    </div>
                </div>
        ...
        <div class="print-root w-full lg:w-2/3">
            <div class="print-card bg-white rounded-2xl shadow-lg p-4 sm:p-6">
                <h3 class="print-hide text-lg sm:text-xl font-bold text-slate-800 mb-4 sm:mb-6">Certificate Preview</h3>
